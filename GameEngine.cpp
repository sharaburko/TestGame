        ...
        if (init.getChip()[i].numberPositionShape == activChip) {
            ...
            if (!roadActivChip.empty()) {
                ...
                if (distance > 3) {
                    ...
                    init.setVectorChip()[i].shape.setPosition(init.getPositionPoints()[roadActivChip[stepActivChip] - 1].getCoordinateX(), init.getPositionPoints()[roadActivChip[stepActivChip] - 1].coordinateY);
